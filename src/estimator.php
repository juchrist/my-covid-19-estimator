...
function assessmentThree(){
    ...
    $GLOBALS['dollarsInFlight'] = int_val(($GLOBALS['infectionsByRequestedTime'] * $GLOBALS['avgDailyIncomeInUSD'] * $GLOBALS['avgDailyIncomePopulation']) / $GLOBALS['estimatedPeriod']);
}
